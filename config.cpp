...
int LOW_FREQ_WAIT = 200000;
int SKIP_FACTOR = LOW_FREQ_WAIT / HIGH_FREQ_WAIT * PERCENTAGE_ENERGY_DURATION;
int STATE_GENERAL_DURATION = HIGH_FREQ_WAIT;

// int STATE_DURATION = STATE_GENERAL_DURATION;
...
int PERCENTAGE_ENERGY_DURATION = 10;

bool terminateFlag = false;
bool classifierWorking = true;
bool realSimulation = false;
