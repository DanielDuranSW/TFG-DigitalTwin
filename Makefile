...
OBJS := main.o dma_monitor.o threads/FSR_Acquisition.o threads/IMU_Acquisition.o threads/RAM_Operation.o threads/BLE_Stack_Operation.o threads/Energy_Saving.o threads/Custom_Event_Handler.o
...
main.o: dma_monitor.h threads/FSR_Acquisition.h threads/IMU_Acquisition.h threads/RAM_Operation.h threads/BLE_Stack_Operation.h threads/Energy_Saving.h threads/Custom_Event_Handler.h
	$(CC) $(CPPFLAGS) -c main.cpp

dma_monitor.o: dma_monitor.h
	$(CC) $(CPPFLAGS) -c dma_monitor.cpp
